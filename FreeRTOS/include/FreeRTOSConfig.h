...
#define configCPU_CLOCK_HZ                          CORE_CLK
...
/* Heap memory definitions. */
#define configTOTAL_HEAP_SIZE                       4096
#define configHEAP_MEMORY_SCHEME                    2
...
#define configPRIORITY_BITS                                 2
#define configLIBRARY_LOWERST_INTERRUPT_PRIORITY            3
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY        1
#define configKERNEL_INTERRUPT_PRIORITY         (configLIBRARY_LOWERST_INTERRUPT_PRIORITY << (8 - configPRIORITY_BITS))
